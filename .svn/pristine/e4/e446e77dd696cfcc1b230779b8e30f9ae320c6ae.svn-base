...
import com.org.palmcampus.email.provider.AttachmentProvider;
...
public class GridViewAdapter<T> extends BaseAdapter {
	...
	public void appendToList(Attachment affInfos) {
		if (affInfos == null) {
			return;
		}
		mList.add((T) affInfos);
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		Bitmap bitmap=affInfos.getImage();
